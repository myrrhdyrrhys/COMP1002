/*
Note: I am not submitting this test file as my own. I simply wanted to attach the test file I used to test the functionality of my DSALinkedList.java program, so that the marker may use this to ensure the function works as intended.
*/
